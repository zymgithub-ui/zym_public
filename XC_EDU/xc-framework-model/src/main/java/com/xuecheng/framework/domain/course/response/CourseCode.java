...
public enum CourseCode implements ResultCode {
    ...
    COURSE_GET_NOEAISTS(false,31106,"没有相关课程"),
    COURSE_PUBLISH_CREATE_INDEX_ERROR(false,31006,"创建索引失败"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false,31008,"课程等级错误"),
    COURSE_MEDIA_TEACHPLAN_ISNULL(false,31007,"课程计划为空");
    //操作代码
